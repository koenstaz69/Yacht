          ...
          <div class="r-advantage-main-part r-advantage-main-part-white">
            <div class="container clearfix">
              <div class="advantage-head">
                <span>40+ Yacht TYPES &amp; BRANDS</span>
                <h2>Coral Yachts <b>Advantages.</b></h2>
              </div>
              <div class="row clearfix">
                 <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                   <div class="r-advantages-box">
                     <div class="icon"> <img src="assets/images/custom_supp.png" alt=""> </div>
                 ...
                 <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                   <div class="r-advantages-box">
                     <div class="icon"> <img src="assets/images/icon_reserv.png" alt=""> </div>
                 ...
                 <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                   <div class="r-advantages-box">
                     <div class="icon"> <img src="assets/images/icon_loc.png" alt=""> </div>
              ...
              <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12">
                  <div class="r-about-info-img">
                    <img src="assets/images/group.png"  class="img-fluid d-block m-auto" alt="">
                  </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12">
                  <div class="r-about-info-content">
                    ...
                    <ul class="mb-0 pl-0">
                      ...
                      <li><i class="fa fa-check-circle"></i> All brand &amp; type Yachts in our garage</li>
